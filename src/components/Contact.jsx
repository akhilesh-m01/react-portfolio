  ...
  return (
    <div name="contact" className='w-full h-screen bg-gradient-to-b from-black to-gray-500 p-4 text-white'>
        ...
        <div className='flex flex-col p-4 justify-center max-w-screen mx-auto h-full'>
            <div className='pb-8'>
                <p className='text-4xl flex-bold inline border-b-4 border-gray-500'>Contact</p>
                <p className='py-6'>Submit the below form to get in touch with me</p>
            </div>

            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/lbjkmoea"
                method='POST' className='flex flex-col w-full md:w-1/2'>
                    ...
                    <button className='text-white bg-gradient-to-b from-cyan-500 to-blue-500 px-6 py-3 my-8 mx-auto'>Let's Talk</button>
                </form>
            </div>
